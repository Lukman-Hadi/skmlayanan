    ...
    return (
        <div className="">
            ...
            <div className="justify-center">
                <h1 className="text-center pt-20 font-quicksand font-black text-4xl md:text-7xl md:pt-8">{indicator.indicator}</h1>
            </div>
            {/* radio group */}
            <div className="flex w-full h-full md:h-3/5 justify-center mt-14 md:mt-0 lg:mt-1 sm:mt-5 flex-wrap">
                {/* img+input */}
                <div className="w-2/5 mx-2 md:w-1/5 md:mx-2 lg:my-10 lg:py-20 md:px-2 h-auto md:py-4 md:my-0">
                    <label className="radioimg">
                        ...
                        <p className="mb-10 md:pt-10 font-monstserrat font-bold text-xl">Sangat Buruk</p>
                    </label>
                </div>
                <div className="w-2/5 mx-2 md:w-1/5 md:mx-2 lg:my-10 lg:py-20 md:px-2 h-auto md:py-4 md:my-0">
                    <label className="radioimg">
                        ...
                        <p className="mb-10 md:pt-10 font-monstserrat font-bold text-xl">Buruk</p>
                    </label>
                </div>
                <div className="w-2/5 mx-2 md:w-1/5 md:mx-2 lg:my-10 lg:py-20 md:px-2 h-auto md:py-4 md:my-0">
                    <label className="radioimg">
                        ...
                        <p className="mb-10 md:pt-10 font-monstserrat font-bold text-xl">Baik</p>
                    </label>
                </div>
                <div className="w-2/5 mx-2 md:w-1/5 md:mx-2 lg:my-10 lg:py-20 md:px-2 h-auto md:py-4 md:my-0">
                    <label className="radioimg">
                        ...
                        <p className="mb-10 md:pt-10 font-monstserrat font-bold text-xl">Sangat Baik</p>
                    </label>
                </div>
            </div>
